...
typedef BlocComponentBuilder<S> = Iterable<Component> Function(
...
/// [BlocBuilder] handles building components in response to new `states`.
...
///   // yield components here based on BlocA's state
///   }
/// )
/// ```
///
